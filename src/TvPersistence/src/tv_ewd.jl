...
"""
    compute_beta_scale(alpha0::Vector{Float64}, J::Int, KMAX::Union{Int, String}) = "Maximum" -> Vector{Float64}
...
- `KMAX::Union{Int, String}: Maximal number of shifts that go into the betaScale calculation
...
"""
function compute_beta_scale(alpha0, J::Int, KMAX::Union{Int,String} = "Maximum")::Vector{Float64}
...
"""
    compute_eps_scale(T::Int, Eps::Vector{Float64}, J::Int) -> Vector{Float64}
...
- `J::Int`: The scale at which EpsScale values are computed.

# Returns
- `Vector{Float64}`: A vector of computed EpsScale values at scale J.
"""
...
"""
    compute_g_scale(T::Int, beta_scale, eps_scale, KMAX::Int, J::Int) -> Vector{Float64}
...
- `beta_scale`: The vector of beta-Scale values at the given scale J (calculated with compute_beta_scale()).
- `eps_scale`: The vector of epsilon-Scale values at the given scale J (calculated with compute_eps_scale()).
...
"""
function compute_g_scale(T::Int, beta_scale, eps_scale, KMAX::Int, J::Int)::Vector{Float64}
